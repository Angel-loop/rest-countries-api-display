    ...
    <div className=" p-12 grid-cols-1 gap-12 md:flex md:justify-between md:flex-row">
      ...
      <div>
        <Menu.Button className="inline-flex w-full justify-center rounded-md bg-black bg-opacity-20 px-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 text-center">
          Filter By Region 
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={15} height={15} className="fill-white ml-8">
      ...
      >
        <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-dark-blue shadow-lg focus:outline-none">
            ...
            <Menu.Item>
              {({ active }) => (
                <button
                  ...
                  className={`${
                    active ? 'bg-very-dark-blue text-white' : 'text-gray-900'
